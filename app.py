...
#                 "account": {
#                     "DOBAsPerPehchaan": account_dob,
#                     "communifrom flask import Flask, render_template, request, send_file
# from datetime import date, timedelta
# import os
# import json, random, tempfile, re
...
#     'Limitless': {'Indicator':'0'},
#     'ABCD': {'Indicator':'0'},
#     'RoomRentModificationOption': {
#         'Indicator':'0',
#         'RoomOccupancyTypeNormal':''
#     },
#     'ModificationofRoomRentUSPR': {'Indicator':'0'},
#     'RemovalOfProtectBenefit': {'Indicator':'0'},
#     'SeriousIllnessBooster': {'Indicator':'0'},
#     'InfiniteBenefit': {'Indicator':'0'},
# }
...
#             if coverage_name == "AggregateDeductible":
...
#                     "CurrentCountryOfResidence": current_country,
#                     "Name": short_name,
#                     "kyc": {
#                         "IsKYCVerified": data.get("kyc_verified", "1")
#                     },
...
#                         "LGCode": data.get("lg_code"),
#                         "LOSCode": data.get("los_code"),
#                         "BankCaseID": data.get("bank_case_id"),
#                         "BankBranchLocation": data.get(
#                             "bank_branch_location", "No"
#                         ),
#                         "CategoryCode": data.get("category_code"),
#                     },
#                     "EffectiveTime": data.get(
#                         "effective_time", "03:30PM"
#                     ),
...
# if __name__ == '__main__':
#     app.run(host='0.0.0.0', port=int(os.environ.get('PORT', 5000)))cation": {
#                         "EmailId": data.get("email", "ub@hdfcergo.com"),
#                         "Mobile": data.get("mobile", "9930247107"),
#                     },
#                     "intermediarydetails": {
